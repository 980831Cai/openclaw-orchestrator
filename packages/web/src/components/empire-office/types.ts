...
export interface Agent {
  ...
  status: AgentStatus;
  empire_status?: EmpireAgentStatus;
  empire_status_label?: string | null;
...
export interface ProviderModelConfig {
  model: string;
  subModel?: string; // 靹滊笇 鞐愳澊鞝勴姼(鞎岆皵靸? 氇嵏 (claude, codex毵?頃措嫻)
  reasoningLevel?: string; // Codex: "low"|"medium"|"high"|"xhigh"
  subModelReasoningLevel?: string; // 鞎岆皵靸?於旊 霠堧波 (codex毵?頃措嫻)
}
